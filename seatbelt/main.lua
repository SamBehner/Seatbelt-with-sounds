...
Citizen.CreateThread(function()
	while true do
		...
		if car ~= 0 and (wasInCar or IsCar(car)) and not IsPauseMenuActive() then
			wasInCar = true				
			...
			if beltOn then 
				...
				---- Hier kannst du den Sound beim Anschnallen ändern --------- Hier -----
				...
				---- Hier kannst du den Sound beim ABschnallen ändenr --------- Hier -----
